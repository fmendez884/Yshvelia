...
public class HitboxManager : MonoBehaviour
{
    ...
    private GameObject GenerateHitbox(Transform bone, int frameIndex)
    {
        ...
        Transform hitboxBone = bone.parent != null ? bone.parent : bone;
    ...
    public void ClearHitboxes()
    {
        ...
        {
            if (child.name.Contains("Hitbox")) // Adjust if your hitboxes have a specific naming convention or tag
            {
    ...
    public void FindAndStoreHitboxes()
    {
        ...
        // Traverse the character hierarchy to find all hitboxes
        foreach (Transform child in targetModel.GetComponentsInChildren<Transform>())
        {
            // if (child.gameObject.name.Contains("Hitbox") || child.CompareTag("Hitbox")) // Check name or tag
